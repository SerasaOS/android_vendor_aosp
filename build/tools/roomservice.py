...
# Copyright (C) 2020-2022, Project Morbid
...
morbid_manifest = ".repo/manifests/snippets/morbid.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    morbidm = load_manifest(morbid_manifest)
    ...
    for repo in repos:
        ...
        if exists_in_tree(morbidm, repo_path) != None:
            existing_m_project = exists_in_tree(morbidm, repo_path)
