...
ALARM_PATH := vendor/morbid/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/morbid/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/morbid/prebuilt/common/media/audio/ringtones
