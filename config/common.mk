...
PRODUCT_COPY_FILES += \
    vendor/morbid/prebuilt/common/bin/backuptool_ab.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.sh \
    vendor/morbid/prebuilt/common/bin/backuptool_ab.functions:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.functions \
    vendor/morbid/prebuilt/common/bin/backuptool_postinstall.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_postinstall.sh
...
# Morbid-specific init rc file
PRODUCT_COPY_FILES += \
    vendor/morbid/prebuilt/common/etc/init/init.morbid-system_ext.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.morbid-system_ext.rc
...
# Fonts
include vendor/morbid/config/fonts.mk
...
PRODUCT_COPY_FILES += \
    vendor/morbid/prebuilt/common/bin/clean_cache.sh:system/bin/clean_cache.sh
...
PRODUCT_COPY_FILES += \
    vendor/morbid/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
